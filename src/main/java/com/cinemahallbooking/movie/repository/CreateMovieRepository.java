...
public interface CreateMovieRepository extends MongoRepository<CreateMovieModel, String> {
    ...
    boolean existsByReleaseDateAndLocations_IdAndCinemaHalls_IdAndCinemaHalls_ShowTimings_Time(
            LocalDate releaseDate, List<String> locationIds, String cinemaHallId, String showTime);
